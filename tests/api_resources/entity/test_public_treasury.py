...
class TestPublicTreasury:
    ...
    def test_method_get_coin_id(self, client: Coingecko) -> None:
        public_treasury = client.entity.public_treasury.get_coin_id(
            coin_id="bitcoin",
            entity="companies",
        )
    ...
    def test_raw_response_get_coin_id(self, client: Coingecko) -> None:
        response = client.entity.public_treasury.with_raw_response.get_coin_id(
            coin_id="bitcoin",
            entity="companies",
        )
    ...
    def test_streaming_response_get_coin_id(self, client: Coingecko) -> None:
        with client.entity.public_treasury.with_streaming_response.get_coin_id(
            coin_id="bitcoin",
            entity="companies",
        ) as response:
    ...
    def test_path_params_get_coin_id(self, client: Coingecko) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `coin_id` but received ''"):
            client.entity.public_treasury.with_raw_response.get_coin_id(
                coin_id="",
                entity="companies",
            )
...
class TestAsyncPublicTreasury:
    ...
    async def test_method_get_coin_id(self, async_client: AsyncCoingecko) -> None:
        public_treasury = await async_client.entity.public_treasury.get_coin_id(
            coin_id="bitcoin",
            entity="companies",
        )
        assert_matches_type(PublicTreasuryGetCoinIDResponse, public_treasury, path=["response"])
    ...
    async def test_raw_response_get_coin_id(self, async_client: AsyncCoingecko) -> None:
        response = await async_client.entity.public_treasury.with_raw_response.get_coin_id(
            coin_id="bitcoin",
            entity="companies",
        )
    ...
    async def test_streaming_response_get_coin_id(self, async_client: AsyncCoingecko) -> None:
        async with async_client.entity.public_treasury.with_streaming_response.get_coin_id(
            coin_id="bitcoin",
            entity="companies",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_coin_id(self, async_client: AsyncCoingecko) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `coin_id` but received ''"):
            await async_client.entity.public_treasury.with_raw_response.get_coin_id(
                coin_id="",
                entity="companies",
            )
