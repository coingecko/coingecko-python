...
class TestBalances:
    ...
    def test_raw_response_get(self, client: Coingecko) -> None:
        response = client.onchain.wallets.balances.with_raw_response.get(
            address="address",
            networks="networks",
        )
    ...
    def test_streaming_response_get(self, client: Coingecko) -> None:
        with client.onchain.wallets.balances.with_streaming_response.get(
            address="address",
            networks="networks",
        ) as response:
    ...
    def test_path_params_get(self, client: Coingecko) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            client.onchain.wallets.balances.with_raw_response.get(
                address="",
                networks="networks",
            )
...
class TestAsyncBalances:
    ...
    async def test_method_get(self, async_client: AsyncCoingecko) -> None:
        balance = await async_client.onchain.wallets.balances.get(
            address="address",
            networks="networks",
        )
        assert_matches_type(BalanceGetResponse, balance, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncCoingecko) -> None:
        response = await async_client.onchain.wallets.balances.with_raw_response.get(
            address="address",
            networks="networks",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncCoingecko) -> None:
        async with async_client.onchain.wallets.balances.with_streaming_response.get(
            address="address",
            networks="networks",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get(self, async_client: AsyncCoingecko) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `address` but received ''"):
            await async_client.onchain.wallets.balances.with_raw_response.get(
                address="",
                networks="networks",
            )
